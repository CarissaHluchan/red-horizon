describe('allMarsMedia spec.', () => {
  ...
  it('should perform a hover and show a title of a surface feature', () => {
    ...
    .get(':nth-child(1) > a > .single-thumnail').should('be.visible')
    ...
    .get(':nth-child(2) > a > .single-thumnail').should('be.visible')
    ...
    .get(':nth-child(3) > a > .single-thumnail').should('be.visible')
    ...
    .get(':nth-child(4) > a > .single-thumnail').should('be.visible')
    ...
    .get(':nth-child(5) > a > .single-thumnail').should('be.visible')
    ...
    .get(':nth-child(6) > a > .single-thumnail').should('be.visible')
