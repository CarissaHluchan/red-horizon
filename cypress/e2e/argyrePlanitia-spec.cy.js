describe('argyrePlanitia spec.', () => {
  ...
  it('should perform a hover and show a title of the Argyre Planitia feature', () => {
    cy.get('.argyre-planitia-wrapper').realHover()
      .get('.hover-text-argyre-planitia').contains('Argyre Planitia')
      .get('.argyre-planitia-wrapper').realClick()
