describe('vallesMarineris spec.', () => {
  ...
  it('should perform a hover and show a title of the Valles Marineris feature', () => {
    cy.get('.valles-marineris-wrapper').realHover()
      .get('.hover-text-valles-marineris').contains('Valles Marineris')
      .get('.valles-marineris-wrapper').realClick()
