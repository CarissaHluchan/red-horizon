describe('User will be able to select an image and view its details in a single image view', () => {
  ...
  it('should go into the all mars view, select an item, and view item', () => {
    ...
    .get('.single-media-date').should('contain', 'Tuesday, November 30 2004')
    ...
    .get('.single-media-main-image').should('be.visible')
    .get('.single-media-date-label').contains('Date Created:')
    .get('.single-media-date').should('contain', 'Wednesday, October 8 2003')
    .get('.single-media-description-label').contains('Description:')
    ...
    .get('.single-media-main-image').should('be.visible')
    .get('.single-media-date-label').contains('Date Created:')
    .get('.single-media-date').should('contain', 'Friday, December 12 1997')
    .get('.single-media-description-label').contains('Description:')
    ...
    .get('.single-media-main-image').should('be.visible')
    .get('.single-media-date-label').contains('Date Created:')
    .get('.single-media-date').should('contain', 'January 2 2004')
    .get('.single-media-description-label').contains('Description:')
    ...
    .get('.single-media-main-image').should('be.visible')
    .get('.single-media-date-label').contains('Date Created:')
    .get('.single-media-date').should('contain', 'Wednesday, August 25 1999')
    .get('.single-media-description-label').contains('Description:')
    ...
    .get('.single-media-main-image').should('be.visible')
    .get('.single-media-date-label').contains('Date Created:')
    .get('.single-media-date').should('contain', 'Tuesday, January 13 2004')
    .get('.single-media-description-label').contains('Description:')
